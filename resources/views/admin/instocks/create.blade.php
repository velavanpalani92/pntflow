...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.instock.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.instocks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('serialno') ? 'is-invalid' : '' }}" type="text" name="serialno" id="serialno" value="{{ old('serialno', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('orderno') ? 'is-invalid' : '' }}" type="text" name="orderno" id="orderno" value="{{ old('orderno', '') }}">
